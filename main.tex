...
\shorterSection{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \item \small Ongoing research work on deep rationalization, learning disentangled latent spaces.
      \item \small Reviewed background work and experimented with new methods for NLP (language models, multi-task learning, representation learning, semi-supervised learning), automatic program repair (graph neural networks) and computational chemistry (molecular property prediction, drug design)
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
          \item \small Designed, implemented and benchmarked hierarchical neural architectures on logical reasoning tasks with PyTorch. Experimented with hypernetworks in a meta-learning setting.
      \resumeItemListEnd

    \resumeSubheading
      {Software Engineer Intern}{Paris, France}
