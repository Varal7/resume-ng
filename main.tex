...
\shorterSection{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {MIT Computer Science and Artificial Intelligence Laboratory (MIT CSAIL) - Regina Barzilay group}{Sep 2017 - Ongoing}
      \resumeItemListStart
      \item \small Ongoing research work on \textbf{privacy-preserving machine learning} in the context of applying Deep Learning to medical images.
      \item \small Reviewed background work and experimented with new methods for \textbf{NLP} (language models, multi-task learning, representation learning, semi-supervised learning), \textbf{automatic program repair} (graph neural networks) and \textbf{computational chemistry} (molecular property prediction, drug design).
      \resumeItemListEnd
...
\hspace{-9pt}
\faFile[regular]~
\textbf{Syfer: Neural Obfuscation for Private Data Release}, arXiv 2022
}
    \vspace{-5pt}
    \item[]\small{
\hspace{-9pt}
